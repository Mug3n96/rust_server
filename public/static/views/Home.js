    ...
    return `
      <article class="article home">
        <header class="article-header__container">
          ...
          <h5 class="article-header__subtitle">IP: 173.212.227.88</h5>
        </header>
        <p>We will envolve players as much as we can into the decisions. If you dont like smth about the serversetting or you know a good plugin which you would love to see on this server, just tell us that. If we, or the players have nothing to say against it, we will include your idea into the server.</p>
        <ul>
